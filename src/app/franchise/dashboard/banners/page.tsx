        ...
        <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
          ...
          <DialogContent className="max-w-md">
            ...
            <div className="space-y-4 py-4">
              ...
              <div className="space-y-2">
                <Label>Hero Image Selection</Label>
              ...
              <div className="mt-4 border rounded-lg overflow-hidden bg-muted/20 flex items-center justify-center aspect-video relative">
                 <Image 
                 ...
                 />
                 <span className="relative z-10 text-[10px] font-black uppercase text-white drop-shadow-md">Preview Mode</span>
              </div>
            </div>
            <DialogFooter>

  ...
  if (userLoading || profileLoading) {
    return (
      <div className="flex flex-col min-h-screen bg-white items-center justify-center p-6">
        ...
        <p className="text-xs font-black uppercase tracking-widest text-muted-foreground">Accessing Vault...</p>
      </div>
    );
  }
      ...
      <div className="px-4 -mt-10 relative z-20 space-y-4">
        ...
        <Card className="border-none shadow-xl rounded-[32px] overflow-hidden bg-white">
          <CardContent className="p-0">
            <div className="p-6 flex justify-between items-center">
              <div>
                <h3 className="text-3xl font-black text-[#333] leading-none">{profile?.loyaltyPoints || 0} LP COINS</h3>
                <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest mt-2">1 LP Coin = ₹1</p>
              </div>
              <Button variant="outline" className="rounded-xl h-10 border-green-100 text-[#14532d] font-black text-[10px] uppercase tracking-widest gap-2">
            ...
            <div className="bg-[#fff3e0] py-2 px-6 border-y border-[#ffe0b2]">
              <button className="text-[10px] font-black text-[#e65100] uppercase tracking-widest underline decoration-2 underline-offset-4 flex items-center gap-1">
            ...
            <div className="p-8">
              ...
              <div className="text-center">
                <p className="text-sm font-bold text-[#333] uppercase">
                  Order Worth <span className="font-black text-[#14532d]">₹1000</span> To Reach ACE Level
                </p>
              </div>
            </div>
          </CardContent>
        ...
        <Card className="border-none shadow-sm rounded-2xl bg-white active:scale-[0.98] transition-all">
          <CardContent className="p-5 flex justify-between items-center">
            <span className="text-[13px] font-bold text-[#333] uppercase tracking-tight">Expired/Redeemed Rewards</span>
